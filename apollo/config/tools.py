...
def get_available_tools() -> List[Dict[str, Any]]:
    ...
    tools = [
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "include_pattern": {
                            "type": "string",
                            "description": "A glob pattern to restrict the search to files with matching paths (e.g., '*.py', 'src/**/*.js').",
                        },
                        "exclude_pattern": {
                            "type": "string",
                            "description": "A glob pattern to exclude files from the search (e.g., '*.log', 'node_modules/**').",
                        },
                        "explanation": {
                            "type": "string",
                            "description": "A clear and concise explanation of why this specific pattern is being searched for.",
                        },
                    },
                },
            },
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "target_file": {
                            "type": "string",
                            "description": "The exact path of the file to be deleted, relative to the workspace root.",
                        },
                        "explanation": {
                            "type": "string",
                            "description": "A clear and concise explanation of why this file is being deleted.",
                        },
                    },
                },
            },
        ...
        },
        {
            ...
            "function": {
                "name": "remove_dir",
                "description": "Recursively and permanently removes a directory and all of its contents. This action is irreversible.",
                "parameters": {
                    "type": "object",
                    "required": ["target_file", "explanation"],
                    "properties": {
                        "target_file": {
                            "type": "string",
                            "description": "The path of the directory to be removed, relative to the workspace root.",
                        },
                        "explanation": {
                            "type": "string",
                            "description": "A clear and concise explanation of why this directory is being removed.",
                        },
                    },
                },
            },
